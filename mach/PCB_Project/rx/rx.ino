...
Serial.print("Throttle: "); Serial.print(ch1_value);  Serial.print("    ");
Serial.print("Yaw : "); Serial.print(ch2_value);  Serial.print("    ");
Serial.print("Pitch : "); Serial.print(ch3_value);  Serial.print("    ");
Serial.print("Roll : "); Serial.print(ch4_value);  Serial.print("\n");
